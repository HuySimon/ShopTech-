...
const CategoryProduct = () => {
    ...
    urlCategoryListinArray.forEach((category) => {
        urlCategoryListObject[category] = true; // {category1: true, category2: true}
    });
    ...
    useEffect(() => {
        ...
        const urlFormat = arrayOfCategory.map((category, index) => {
            ...
            <div className="hidden lg:grid grid-cols-[200px,1fr] gap-4">
                ...
                <div className="px-4">
                    ...
                    <div className="min-h-[calc(100vh-120px)] overflow-y-scroll max-h-[calc(100vh-120px)] scrollbar-none">
                        {data.lenght !== 0 && <VerticalCard data={data} loading={loading} />}
                    </div>
                </div>
            </div>
        </div>
