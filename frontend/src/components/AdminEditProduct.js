...
const AdminEditProduct = ({ onClose, dataProduct, callFunc }) => {
    ...
    return (
        <div className="fixed top-0 bottom-0 left-0 right-0 bg-slate-200 bg-opacity-50 w-full h-full flex items-center justify-center">
            <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
                ...
                <form className="grid py-4 gap-3 overflow-y-scroll h-full pb-5" onSubmit={handleSubmit}>
